...
def load_google_trained_w2v(vocabulary_inv, embedding_dim):
    embedding_model = KeyedVectors.load_word2vec_format('./trained_word2vec/GoogleNews-vectors-negative300.bin',
                                                        binary=True)
    embedding_weights = [np.array([embedding_model[w] if w in embedding_model
